...
public class TicketMasterAPI implements ExternalAPI {
	...
	private static final String API_KEY = "lc9r2Uh9KqLA96QT05D1C4adOlYMkf2C";
	...
	private List<Item> toItemList(JSONArray events) throws JSONException {
	...
	private String getImageUrl(JSONObject event) throws JSONException {
		if (!event.isNull("images")) {
			...
			if (imagesArray.length() >= 1) {
				//As an example, we only get the first image here 
